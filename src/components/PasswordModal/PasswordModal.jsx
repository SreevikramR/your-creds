    ...
    return (
        <>
            ...
            <div style={styles.modal} onClick={() => console.log("modal click")}>
                <div className='bg-blue-600 w-full pr-3 rounded-t-2xl pl-6 flex justify-between content-center flex-wrap text-white text-4xl font-semibold flex-row'><span className='my-6'>View Password</span><span className='flex justify-end text-black cursor-pointer h-fit' onClick={() => setShowModal(false)}>&times;</span></div>
